function plot_like_biphasic(single_values, anodic_cathodic_data, ...
...
title('Biphasic modelling, 40 to 70 dB uA', 'fontsize', 16)
...
[t_values_reversed_pseudomonophasic_cathodic,...
    ...
    getOnePulse(phase_duration_s, -8, 1);
[t_values_monophasic_cathodic,...
    y_values_monophasic_cathodic] = ...
    getOnePulse(phase_duration_s, Inf, -1);
...
plot([4.4 11.2], ...
    ...
    'k-')
hold on
plot(t_values_monophasic_cathodic+5, -0.6*y_values_monophasic_cathodic+10.5, 'r-', 'linewidth', 2)
hold on
plot(t_values_monophasic_cathodic+6.5, 0.6*y_values_monophasic_cathodic+10.5, 'k-', 'linewidth', 2)
hold on
...
plot([11.4 18.2], ...
    ...
    'k-')
hold on
plot(t_values_monophasic_cathodic+12, 0.6*y_values_monophasic_cathodic+10.5, 'k-', 'linewidth', 2)
hold on
plot(t_values_monophasic_cathodic+13.5, -0.6*y_values_monophasic_cathodic+10.5, 'r-', 'linewidth', 2)
hold on
...
saveas(gcf, sprintf('figures%sBiphasic_all_levels_figure.pdf', filesep))